...
#codigos:
    ...
    def codigoagrgar(self):
        ...
        if archivo:
            ...
            Label13 = tk.Label(self.miframe, image=render, bg="light gray")
    ...
    def save_imagen(self):
        direccion = self.datos.get()
        if direccion:
            comando = ["python", "cliente_aux1.py"]
    ...
    def fusionar_imagen(self):
        ...
        ruta = "C:/Users/Dark6/Documents/Python/ProyectoFinal/Recibida2.jpg" #cambiar siempre
        if respuesta:
            if os.path.exists(ruta):
                ...
                fusionada.save('imagen_fusionada1.jpg')
                fusion = "C:/Users/Dark6/Documents/Python/ProyectoFinal/imagen_fusionada1.jpg" #cambiar siempre
                ...
                messagebox.showinfo("Falta archivo...", "El archivo Recibida2.jpg no se encuentra en el dispositivos")
        else:
